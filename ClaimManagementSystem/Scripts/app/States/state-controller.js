(function () {
    ...
    var ListAllStatesController = function ($scope, $routeParams, statesService) {
        //$scope.companiesGridOptions = {};


        $scope.GetAllStates = function () {
            var countries = statesService.query(function (response) {
                $scope.stateOptions = {
                    dataSource: response,
    ...
    angular.module("ClaimsManagementModule")
            .controller("StatesController", ["$scope", "$routeParams", "StatesService", ListAllStatesController]);
}());